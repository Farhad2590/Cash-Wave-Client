...
//                         <ul className="menu menu-horizontal px-1">
//                             <li className="">
//                                 <NavLink to="/dashboard/userDashboard" className="flex items-center justify-center gap-2 p-2 text-black bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200">
//                                     <FaHome />
//                                    Dashboard
//                                 </NavLink>
//                             </li>
